...
public:
  ...
  std::pair<int, double> DistanceToPoint(const Vec2d &point) const;
  /**
   ...
   */
  Polygon2d ExpandEdgeByDistance(const double exp_dis, const double sep_dis, const double kMinAngle = 0.1) const;
